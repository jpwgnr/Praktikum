...
zu $m = \SI[per-mode=fraction]{0.016939}{\per\square\meter}$. Damit ist der Elastizitätsmodul mit \eqref{eqn:E12}%1/m²
$E = \SI{459.04}{\giga\pascal}$.
\newpage

\subsection{Bestimmung des Elastizitätsmoduls des zweiten Stabes}

\input{./tables/Stab2.tex}
...
\begin{figure}
  ...
  \label{fig:plot3a}
\end{figure}
\noindent Mit der Steigung $m = \SI[per-mode=fraction]{0.002429}{\per\square\meter}$, die mit \eqref{eqn:m}%m 0.002430?
