...
\end{align*}
Mit Gleichung \eqref{eqn:eta} und Gleichung \eqref{eqn:etaerr} berechnet sich die Viskosität mit $K_\text{klein}$,
...
\input{build/tabsolution5.tex}
\input{build/tabsolution6.tex}
\begin{figure}
    \centering
