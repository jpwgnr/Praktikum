...
\noindent Die Steigung der Fits ergibt sich zu 

\begin{align*}
    m_1 &= \SI{8199.29}{\per\meter\per\henry}\\
    m_2 &= \SI{7062.35}{\per\meter\per\henry}.
\end{align*}
...
\begin{align*}
    \left(\frac{e_0}{m_0}\right)_1 &= \SI{1.34e11}{\coulomb\per\kilogram}\\
    \left(\frac{e_0}{m_0}\right)_2 &= \SI{1.44e11}{\coulomb\per\kilogram}.
\end{align*}

\noindent Der Mittelwert ergibt sich zu 
\begin{equation*}
    \frac{e_0}{m_0} = \SI{1.39(05)e11}{\coulomb\per\kilo\gram}.
\end{equation*}
