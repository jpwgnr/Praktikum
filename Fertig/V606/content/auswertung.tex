...
Die Molmasse des ersten Elements stammt von einem Rechner für Molare Masse \cite{C6}. %brauchen wir das noch wenn wir die Dichte ändern?

\input{tables/tab2.tex} %Dichte einfügen, \cite{Dichte}
...
\input{tables/tab1.tex} %falsche Tabelle
