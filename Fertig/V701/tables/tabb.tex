\begin{table}\caption{Die Werte für den Druck in dem Glaszylinder, den effektiven Abstand, die Anzahl der Pulse, die Position des Maximums und die ermittelten Energien bei einem Abstand $d = \SI{2}{\centi\meter}$.}
\label{tabb}
\centering
