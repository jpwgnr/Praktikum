...
\begin{equation*}
    L = \SI{168.1(9)}{\joule\per\gram}. %Einheit? Einheiten stehen alle auf dem heiligen Zettel :D müsste Pa*s sein oder so, wenn ich mich richtig erinnere.
\end{equation*}
...
\begin{align*}
    ...
    \frac{\Delta m}{\Delta t}(15) &= \SI{0.34 \pm 0.31}{\gram\per\second}. %Einheit? Anders angben? kg/Sekunde vermutlich. Ich hatte die auch nur m1 genannt. Eigentlich ist das dm/delta*t oder so.
\end{align*}
