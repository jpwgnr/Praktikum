...
\input{build/taba12.tex}
\input{build/taba13.tex}
...
\begin{figure}
    ...
    $\SI{1.94 \pm 0.19}{\milli\tesla}$.} %so okay?
    \label{plota1}
\end{figure}
...
\begin{figure}
    ...
    bestimmt werden können, sind $I = \SI{8.86 \pm 0.30}{\ampere}$, 
    $R = \SI{9.88 \pm 0.35}{\centi\meter}$.}
    \label{plotb1}
\end{figure}
...
\input{build/tabc3.tex}
\input{build/tabc2.tex}
\input{build/tabc4.tex}
