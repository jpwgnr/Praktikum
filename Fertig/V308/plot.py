...
paramHelm1, pcovHelm12 = curve_fit(allgB1, x2r, B2r, p0=[4, 12.5e-2, 1e-2])
errHelm1 = np.sqrt(np.abs(np.diag(pcovHelm12)))
parametersHelm2, pcovHelm2 = curve_fit(allgB2, x2d*1e2, B2d*1e3)
paramHelm2, pcovHelm22 = curve_fit(allgB21, x2d, B2d, p0=[4, 12.5e-2, 9e-2, -2e-2])
errHelm2= np.sqrt(np.abs(np.diag(pcovHelm22)))
parametersHelm3, pcovHelm3 = curve_fit(allgB2, x23*1e2, B23*1e3)
paramHelm3, pcovHelm32= curve_fit(allgB21, x23, B23, p0=[3, 12.5e-2, 10e-2, -2.5e-2])
