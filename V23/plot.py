...
ax4.plot(f_b1_5[178:]*1e-3, amp_b1_5[178:], linewidth=4, label="5 Segmente")
ax4.grid()
ax4.legend()
...
ax5.set_ylabel(r"Amplitude / (a.u.)")
ax5.plot(f_a2_1[178:]*1e-3, amp_a2_1[178:], linewidth=4, label="10 Segmente 50 mm")
ax5.grid()
ax5.legend()
ax6 = fig_6.add_subplot(326)
ax6.set_xlabel(r"$f$ / kHz")
ax6.set_ylabel(r"Amplitude / (a.u.)")
ax6.plot(f_a3[178:]*1e-3, amp_a3[178:], linewidth=4, label="10 Segmente 75 mm")
ax6.grid()
ax6.legend()
