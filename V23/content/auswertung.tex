...
Mit der zuvor bestimmten Lichtgeschwindigkeit von \SI{342.6(7)}{\meter\per\second} ergibt sich für die Frequenzdifferenz ein Wert von \SI{2284(5)}{\hertz}.
...
Das Ergebnis ist als Vergleich zu 10 einzelnen Zylindern der Längen \SI{50}{\milli\metre} und \SI{75}{\milli\metre} ohne Blenden in der rechten Spalte von Abb. \ref{fig:var4} zu sehen. In der Analogie der Pendel entspricht dieser Fall einem Pendel mit alternierenden Massen der Segmente.
...
\begin{table}\caption{Die Amplituden der jeweiligen Peaks bei verschiedenen Winkel.}
    \label{tab:winkel}
    \centering
    \sisetup{round-mode = places, round-integer-to-decimal=true}
...
Das Frequenzspektrum für den Resonator ohe Blende und mit drei verschiedenen Blenden ist in Abb. \ref{fig:molek1} zu sehen.
