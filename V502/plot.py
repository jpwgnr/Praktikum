...
#Generate data 
# V501 Messung 
index1, Ud1= some.neueWerte(file_name="data/dataa1.txt", finished_file="build/taba1.tex",  vars_name=[r"Index", r"$U_\text{d} / \si{\volt}$"], label_text="taba1", caption_text=r"Die Index Werte entsprechen der Höhe die bei der jeweiligen Ablenkspannung $U_\text{d}$ und der Beschleunigungsspannung $U_\text{B} = \SI{180}{\volt}$." , precision=1)
index2, Ud2= some.neueWerte(file_name="data/dataa2.txt", finished_file="build/taba2.tex",  vars_name=[r"Index", r"$U_\text{d} / \si{\volt}$"], label_text="taba2", caption_text=r"Die Index Werte entsprechen der Höhe die bei der jeweiligen Ablenkspannung $U_\text{d}$ und der Beschleunigungsspannung $U_\text{B} = \SI{230}{\volt}$." , precision=1)
index3, Ud3= some.neueWerte(file_name="data/dataa3.txt", finished_file="build/taba3.tex",  vars_name=[r"Index", r"$U_\text{d} / \si{\volt}$"], label_text="taba3", caption_text=r"Die Index Werte entsprechen der Höhe die bei der jeweiligen Ablenkspannung $U_\text{d}$ und der Beschleunigungsspannung $U_\text{B} = \SI{280}{\volt}$." , precision=1)
index4, Ud4= some.neueWerte(file_name="data/dataa4.txt", finished_file="build/taba4.tex",  vars_name=[r"Index", r"$U_\text{d} / \si{\volt}$"], label_text="taba4", caption_text=r"Die Index Werte entsprechen der Höhe die bei der jeweiligen Ablenkspannung $U_\text{d}$ und der Beschleunigungsspannung $U_\text{B} = \SI{330}{\volt}$." , precision=1)
index5, Ud5= some.neueWerte(file_name="data/dataa5.txt", finished_file="build/taba5.tex",  vars_name=[r"Index", r"$U_\text{d} / \si{\volt}$"], label_text="taba5", caption_text=r"Die Index Werte entsprechen der Höhe die bei der jeweiligen Ablenkspannung $U_\text{d}$ und der Beschleunigungsspannung $U_\text{B} = \SI{380}{\volt}$." , precision=1)
...
plt.plot(Ud1/180, d, "xr")
plt.plot(Ud2/230, d, "xb")
plt.plot(Ud3/280, d, "xg")
plt.plot(Ud4/330, d, "xy")
