...
plt.figure(7)
plt.plot(h4, E_pot, 'r-', label='Potentielle Energie')
plt.plot(h4, E_rot, 'b-', label='Rotationsenergie')
plt.plot(h4, E_pot, 'rx')
plt.plot(h4, E_rot, 'bx')
plt.ylabel(r'$E/ \si{\joule}$')
plt.xlabel(r'$h4 / \si{\meter}$')
plt.legend(loc='best')
plt.tight_layout()
