\begin{table} \caption{Die gemessenen Winkel für alle drei Proben für verschiedene Wellenlängen. $\theta_1$ ist der Winkel bei dem Magnetfeld in die eine Richtung und $\theta_2$ für das umgepolte Magnetfeld.}
    \label{tab:winkel}
    \centering
