...
%Hier ist ein Fehler in der Tabelle, deswegen auskommentiert
...
\begin{figure} %Funktion in die Abbildung schreiben?
    ...
    $B_2=\num{-3.87(52)e-5}$, $C_2=\num{-0.87(25)e-2}$ und $D_2=\num{295.99 \pm 0.32}$.} %hier ist irgendwas falsch
    \label{fig:plot1}
\end{figure}
...
\begin{align*}
    T_1 &= \SI{1}{\celsius} &= \SI{274.15}{\kelvin} \\ %celsius geht nicht, degreeCelsius auch nicht, keine Ahnung warum
...
\begin{align*}
    dT_{2,1}(1) &= \num{-0.0130 \pm 0.0026} \\ %0 oder 1 Grad? Lieber in Kelvin angeben?
    dT_{2,2}(5) &= \num{-0.025 \pm 0.004} \\
    dT_{2,3}(10) &= \num{-0.027 \pm 0.007} \\
    dT_{2,4}(15) &= \num{-0.015 \pm 0.012}
\end{align*}
