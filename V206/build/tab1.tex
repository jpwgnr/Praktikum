\begin{table}\caption{Die Temperatur in Reservoire 1 und Reservoir 2 und die dazugehörenden Drücke und die Leistungsaufnahme des Kompressors zu verschiedenen Zeitpunkten.}
\label{tab1}
\centering
\sisetup{round-mode = places, round-precision=2, round-integer-to-decimal=true}
\begin{tabular}{S[]S[]S[]S[]S[]S[]} 
\toprule
{$t /\si{\minute}$} & {$T_{1} /\si{\degree\celsius}} & {$p_{b} / \si{\bar}} & {T_{2} /\si{\degree\celsius}} & {p_{a} /\si{\bar}} & {N /\si{\watt}}\\
\midrule
