...
plt.xlabel(r"$f$ / kHz")
plt.ylabel(r"$B$ / $\mu$T")
plt.plot(f*1e-3, B1*1e6, "x", mew=3, color="C0", markersize=16, alpha=20, label="Peak 1")
plt.plot(f*1e-3, B2*1e6, "x", mew=3, color="C1", markersize=16, alpha=20, label="Peak 2")
