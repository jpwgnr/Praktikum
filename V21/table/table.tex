\begin{table}\caption{Die Frequenz ist gegen den Strom der Sweep-Spule und den Strom der Horizontal-Spule für beide Peaks aufgetragen und die resultierenden $B$-Feldstärken sind auch aufgetragen.}
    \label{tab:all}
    \centering
