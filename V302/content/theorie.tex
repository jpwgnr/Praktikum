...
Bei den vorherigen Schaltungen ist die Frequenz für die Ergebnise nicht relevant. %Nicht wichtig ist auch falsch, da die Frequenz schon einen Einfluss hat. Aber nicht auf die Ergebnisse. 
...
\begin{equation*}
    U_2 = \frac{U_{Br}}{n(2)},
\end{equation*}
wobei der Faktor $n(2)$ das Verhältnis \eqref{eqn:verhaeltnis} ist: $n(2) = \frac{\sqrt{37}}{37}$. %Oder Wurzel aus dem Verhätnis? Versteh ich allgemein nicht, wie bist du auf diese 0.149 gekommen? :D das U Br ändert sich doch. Das ist ja kein konstantes Verhältnis. Und wir haben ja auch einen eigenen Wert für U_S gehabt. 
Da $\omega = 2 \cdot \omega_0$ gilt, ergibt sich für $\Omega$ durch Gleichung \eqref{eqn:omega}
$\Omega = 2$.
Damit wird der Klirrfaktor mittels
\begin{equation}
    k = \frac{U_{Br}}{U_S \cdot n(2)} = \frac{U_{Br} \cdot 37}{U_S \cdot \sqrt{37}}. %n(2) berechnen und einsetzen %Was ist U_1?
    \label{eqn:k}
\end{equation}
berechnet.
