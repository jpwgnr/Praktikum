...
\noindent Für die mittleren Falldauern ergibt sich mit Gleichung \eqref{eqn:mittelwert} %und Standardabweichung? Ja, am besten beide Gleichungen angeben. Der Fehler ist ja die Standardabweichung.
\begin{align*}
...
\begin{equation*}
    \eta = \SI{77.3(7)}{\milli\pascal\second}.%Das stimmt aber nicht oder? Hatte ich das nochmal geändert? Mit den richtigen Ergebnissen sind das 773 microPascal
\end{equation*}
...
Die Reynoldszahlen für die große Kugel bei verschiedenen Temperaturen ergeben sich auf die gleiche Weise und sind in folgender Tabelle aufgetragen. 
\input{build/tab7.tex}
