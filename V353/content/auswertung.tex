...
Phasenverschiebung $\phi$ nötig sind, befinden sich in Tabelle \ref{table: tabd}.
...
Gleichung \eqnref{eqn: phi2} berechnet. In den folgenden Abbildungen \ref{fig: plotd1}, \ref{fig: plotd2} und
...
\begin{figure}
  ...
  \caption{Abhängigkeit der Relativamplitude in Abhängigkeit von der Phase für die in \red{sec: a} 
...
\begin{figure}
  ...
  \caption{Abhängigkeit der Relativamplitude in Abhängigkeit von der Phase für die in \red{sec: b} 
  berechnete Zeitkonstante in einem Polarkoordinatensystem dargestellt. Es sind Daten, ein Fit, der Fehler
  des Fits und die Theoriekurve eingezeichnet.}
  \label{fig: plotd2}
\end{figure}
...
\begin{figure}
  ...
  \caption{Abhängigkeit der Relativamplitude in Abhängigkeit von der Phase für die in \red{sec: c} 
  berechnete Zeitkonstante in einem Polarkoordinatensystem dargestellt. Es sind Daten, ein Fit, der Fehler
  des Fits und die Theoriekurve eingezeichnet.}
  \label{fig: plotd3}
\end{figure}
